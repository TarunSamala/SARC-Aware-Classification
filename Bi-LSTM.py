...
# Build Bi-LSTM model with dual inputs
...
history = model.fit(
    ...
    class_weight={0: 1, 1: 2}  # Adjust based on your class distribution
)
...
# Save model
model.save('sarcasm_detection_biLSTM.h5')